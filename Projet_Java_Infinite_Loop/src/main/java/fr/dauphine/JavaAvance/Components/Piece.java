...
public class Piece {
	...
	public Piece(int posY, int posX) {
		...
		this.possibleOrientations = type.getListOfOrientationByDirections();
	}
	...
	public Piece(int posY, int posX, int typeValue, int orientationValue) {
		this.posX = posX;
		this.posY = posY;
		this.type = PieceType.getTypeFromDirection(typeValue);
		this.orientation = type.getOrientation(Orientation.getOrientations(orientationValue));
		this.connectors = type.setConnectorsList(Orientation.getOrientations(orientationValue));
		this.isFixed = false;
		this.possibleOrientations = type.getListOfOrientationByDirections();
	}
